...
>
bool
transparent_container_input_resource<Container>::is_at_end ()
const noexcept
{
...
>
std::int64_t
transparent_container_input_resource<Container>::get_position ()
const noexcept
{
...
template <
    typename Container
>
const typename transparent_container_input_resource<Container>::content_type&
transparent_container_input_resource<Container>::grab_content ()
const noexcept
{
...
>
void
transparent_container_input_resource<Container>::set_position_raw (
...
>
std::size_t
transparent_container_input_resource<Container>::read_raw (
    std::byte* data,
